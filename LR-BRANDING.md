...
```html
<!-- Primary button -->
<button class="bg-patriot-red text-pure-white rounded-sm px-6 py-3 hover:scale-102 transition-all">
  Start Training
</button>

<!-- Two-tone card -->
<div class="bg-surface border border-border rounded-lg p-6 shadow-sharp hover:shadow-md transition-all">
  <h3 class="text-text-primary font-semibold mb-2">Card Title</h3>
  <p class="text-text-secondary">Card content with <span class="text-patriot-red font-semibold">red highlight</span></p>
</div>
