...
const imageDirs = ['./src/assets/images', './public/images'];
...
async function optimizeImages() {
  ...
  for (const dir of imageDirs) {
    ...
    for (const file of files) {
      ...
      // const filePath = path.join(dir, file); // Unused variable commented out
  ...
  console.log(
    '1. Install image optimization tools: npm install imagemin imagemin-webp imagemin-avif sharp'
  );
...
console.log(
  generatePictureElement(
    'training-1',
    'Professional firearms training session',
